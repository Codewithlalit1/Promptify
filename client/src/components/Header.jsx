...
const Header = () => {
  ...
  return (
    <motion.div className='flex flex-col justify-center items-center text-center my-20'
        ...
        viewport={{once:true}}
    >
        <motion.div className='text-stone-500 incline-flex text-center gap-2bg-white px-6 py-1
         rounded-full border border-neutral-500'
         initial ={{opacity:0,y:-20}}
         animate = {{opacity:1,y:0}}
         transition={{duration:0.8,delay:0.2}}
         >Best text to image generator</motion.div>
        ...
        >Unlease your creativity with AI , Turn your imagination into visual art in seconds - just type, and
